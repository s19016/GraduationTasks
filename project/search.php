    ...
    <header class="header">
      <div class="header-inner">
        ...
        <nav class="header-nav">
          <ul class="nav-list">
            <li class="list-item"><a href="search.php">検索</a></li>
            <!-- /.list-item -->
    ...
    <section class="search">
      ...
      <div class="form-item">
        ...
        >
          ...
          <option value="60years">60代以上</option></select
        ><!-- /# -->
      </div>
      <div class="form-item">
        ...
        >
          ...
          <option value="karaoke">カラオケ</option></select
        ><!-- /# -->
      </div>
      <div class="form-item">
        ...
        >
          ...
          <option value="24time">24時</option></select
        ><!-- /# -->
      </div>
    </section>
    <!-- /.search -->
